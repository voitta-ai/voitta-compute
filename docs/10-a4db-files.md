...
Sizes seen in practice on a production front-crash dump: 1.87 M nodes, 0.86 M quads, 3.85 M hexas, 31 timesteps, 1.6 GB on disk.
...
Combining (1) + (2) gets a 31-frame production crash dump down to ~13 MB encoded with ~150 K vertices.
