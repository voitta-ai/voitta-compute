...
#   plugin-docs-src/<plugin>/  the upstream git checkout — never indexed
PLUGIN_DOCS_DIR = PROJECT_ROOT.parent / "plugin-docs"
PLUGIN_DOCS_SRC_DIR = PROJECT_ROOT.parent / "plugin-docs-src"
